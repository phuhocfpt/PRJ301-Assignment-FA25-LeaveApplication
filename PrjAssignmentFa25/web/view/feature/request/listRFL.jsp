        ...
        <table class="request-table">
            ...
            <tbody>
                ...
                <c:if test="${empty requestScope.listRflEmp}">
                    <tr><td colspan="7" style="text-align:center;color:#6c757d;">Bạn chưa tạo đơn nào.</td></tr>
                </c:if>
            </tbody>
        </table>
            ...
            <table class="request-table">
                ...
                <tbody>
                    ...
                    <c:if test="${empty requestScope.listRflDept}">
                        <tr><td colspan="7" style="text-align:center;color:#6c757d;">Không có đơn nào trong phòng ban.</td></tr>
                    </c:if>
                </tbody>
            </table>
