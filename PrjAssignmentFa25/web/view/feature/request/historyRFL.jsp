...
<div class="content-area">
    ...
    <div class="form-container">
        ...
        <table class="request-table">
            ...
            <tbody>
                <c:forEach var="h" items="${history}">
                    <tr>
                        <td><fmt:formatDate value="${h.changedTime}" pattern="dd/MM/yyyy HH:mm:ss"/></td>
        ...
        <div style="margin-top:1.5rem;">
            <a href="${pageContext.request.contextPath}/request/detail?reqid=${reqid}" class="form-submit-button">Quay lại chi tiết</a>
